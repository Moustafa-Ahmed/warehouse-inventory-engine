...
7. The exact mock-provider shipment, webhook-delivery, and webhook-receipt processing states—and whether exact replay reuses one mock-provider webhook row—must be approved before P1.11.
